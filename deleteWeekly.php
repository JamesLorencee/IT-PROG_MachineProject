...
?>
    ...
    <script type="text/javascript">
        function confirmation() {
            alert("Confirmation Deletion of Records?")
        }
    </script>
    ...
    <body>
        <div id="container">
            <div id="sub-container">
                <h2> Delete Weekly DTR </h2>
                <br>
                <hr>
                <br>
                <div class="week-container">
                    <form method="post" action="deleteWeekly2.php">
                        <label> Week: </label>
                ...
                if (isset($_GET["error"])) {
                    ...
                    //this line will be called by the deletWeekly2.php
                    if ($error == 1) {
                        echo "<p align='center'>The week you have chosen does not exist in the DTR. Please enter again, thank you!<br/></p>";
                    }
                    if ($error == 2) {
                        echo "<p align-'center'>Please choose the week that you want to delete, thank you! </p>";
                    }
                }
                ?>
                <br>
                <a href="delete.php" class="btn">Go Back</a>
