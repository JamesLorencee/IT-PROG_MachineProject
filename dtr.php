        ...
        <div id="container">
            <div id="sub-container">
                ...
                <div class="week-container">
                    <form method="post" action="checkweek.php">
                        <label> Week: </label>
                ...
                if (isset($_GET["error"])) {
                    ...
                    if ($error == 1) {
                        echo "<p align='center'>There exists DTR containing that week.<br/></p>";
                    }
                    if ($error == 2) {
                        echo "<p align-'center'>Choose a week to be added to the records. </p>";
                    }
                }
                ?>
                <br>
