            ...
            <div id='container'>
                <div id="sub-container">
                    <?php
                        ...
                        $_SESSION['id'] = $id;
                    ?>
                        <h2>Choose the day in your DTR that you want to delete</h2>
						<br><hr><br>
                    ...
                    <?php
                        if (isset($_GET["error"])) {
                            ...
                            //this line will be called by the checkday.php to check if selected day exists or not 
                            if ($error == 1) {
                                echo "<p align='center'><br>The date that you are checking does not exist in your DTR. Please enter again, thank you!<br/></p>";
                            }
                            if ($error == 2) {
                                echo "<p align-'center'><br>Please choose a day that you want to delete, thank you!</p>";
                            }
                        }
                    ?>
                </div>
                <form method="post" action="mainMenu.php">
                    <br><input type="submit" value="Back to Main Menu" class="btn" style="width:120px; display: grid; justify-content: center; align-content: center;"/>
                </form>
