    ...
    <body>
        <div id="container">
            <div id="sub-container">
                <h2> Please select a month you want to compute your salary</h2>
                <br>
                <hr>
                <br>
                <div class="week-container">
                    <form method="post" action="checkmonth.php">
                        <label> Month: </label>
				...
				<?php
					if(isset($_GET["error"])){
						...
						//this line will be called by the checkmonth.php
						if ($error == 1) {
							echo "<p align='center'>This month's DTR is not complete yet.<br/></p>";
						}
					}
                ?>
                <br>
