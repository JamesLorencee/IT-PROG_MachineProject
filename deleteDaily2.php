    ...
    <html>
        ...
        <body>
            <div id='container'>
                ...
                <form action="deleteDaily3.php" method="post">
                <?php
                    include("connect.php");
                    ...
                    $query = mysqli_query($DBConnect, "SELECT * FROM tbl_dtr WHERE id='$id' AND shiftDate='$day_input'");
                    $fetch = mysqli_fetch_array($query);
					echo "<h2> Entry to be deleted </h2>
						<div class='table'>
								<table>
									<tr>
										<th>Date</th>
